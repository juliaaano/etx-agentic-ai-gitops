...
def run_agent(pod_name, namespace):
    ...
    #     '{"owner":"juliaaano","repo":"etx-agentic-ai-gitops",'
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'juliaaano', repo 'etx-agentic-ai-gitops', "
